...
contract TokenSwapsModule is ITokenSwapsModule {
    ...
    function swapTokens(
        ...
        IV3SwapRouter.ExactInputSingleParams memory params = IV3SwapRouter.ExactInputSingleParams({
            ...
            amountOutMinimum: uniswapV3CalculateMinOut(aavePM, currentBalance, uniswapV3PoolAddress, tokenOutAddress),
    ...
    function approveAndExecuteSwap(
        ...
        IV3SwapRouter swapRouter = IV3SwapRouter(aavePM.getContractAddress("uniswapV3Router"));
    ...
    function uniswapV3CalculateMinOut(
        ...
        uint256 expectedOut;
        if (tokenOutAddress == pool.token0()) {
